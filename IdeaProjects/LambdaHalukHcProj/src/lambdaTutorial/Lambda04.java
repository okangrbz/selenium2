...
public class Lambda04 extends Universite {
    ...
    fields --> Universite (String)
               ...
               pojo class---> plan old java obj yani model class
               privet variable
               constracteur
               getter setter
               tostring
    ...
    public static void main(String[] args) {
        ...
        System.out.println(notOrt74BuykUnv(unv));
        System.out.println("\n   ***   ");
    ...
    public static boolean notOrt74BuykUnv(List<Universite> unv) {
